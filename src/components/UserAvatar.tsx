...
function _dummyTranslations() {
    ...
    t('رجل مسن ببدلة');
    t('سيدة ببدلة تركواز');
    t('سيدة سمراء ببدلة صفراء');
    t('سيدة محجبة');
    t('رجل عربي رسمي');
    t('رجل بلحية قميص مربعات');
    t('رجل شعر أحمر');
    t('سيدة بنظارات بنفسجي');
    t('سيدة بتسريحة كعكة');
    t('سيدة ببدلة وردية');
    t('رجل أسمر بنظارات');
    t('رجل قميص أبيض وربطة');
    t('سيدة سمراء ببدلة سوداء');
    t('سيدة ببدلة كاجوال');
    t('سيدة قميص أبيض');
    t('رجل أعمال ببدلة زرقاء');
    t('رجل بنظارات ولحية');
    t('سيدة بنظارات ستايل');
    t('رجل بقميص برتقالي');
    t('سيدة بضفيرة');
    t('رجل ببدلة رسمية سوداء');
    t('شاب بنظارات وكنزة حمراء');
}
