    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                            ...
                            <div style={{ gridColumn: 'span 2', display: 'grid', gridTemplateColumns: '2fr 1fr 1fr auto', gap: '8px', alignItems: 'end' }}>
                                <div>
                                    ...
                                    <CustomSelect
                                        value={selectedItem}
                                        onChange={handleItemSelect} ref={itemSelectRef}
                                ...
                                <div>
                                    ...
                                    <input type="number" min="1" value={cartQuantity} onChange={e => setCartQuantity(e.target.value)} style={{ ...IS, height: '36px', textAlign: 'center' }} onFocus={(e) => { focusIn(e); e.target.select(); }} />
                                </div>
                                <div>
                                    <label style={{ ...LS, fontSize: '11px' }}>{t('السعر')}</label>
                                    <input type="number" min="0" value={cartPrice} onChange={e => setCartPrice(e.target.value)} style={{ ...IS, height: '36px', textAlign: 'center' }} onFocus={(e) => { focusIn(e); e.target.select(); }} />
                                </div>
