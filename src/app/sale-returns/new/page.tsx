                        ...
                        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: '16px', padding: '16px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '16px' }}>
                                ...
                                <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '110px 140px 1fr', gap: '20px' }}>
                                    ...
                                    <div>
                                        ...
                                        <input type="date" value={form.date}
                                            ...
                                            style={{ ...IS, background: C.inputBg, border: `1px solid ${C.border}`, color: C.textSecondary, textAlign: 'center', fontSize: '13px', fontFamily: OUTFIT }}
                                ...
                                <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '20px' }}>
                                    <div>
                                        <label style={{ ...LS, fontSize: '11px' }}>{isServices ? t('فاتورة الخدمة الأصلية') : t('فاتورة المبيعات الأصلية')} <span style={{ color: C.danger }}>*</span></label>
                                        <div style={{ position: 'relative' }}>
                                            <CustomSelect
                                                value={form.originalInvoiceId}
                                                onChange={v => { setForm((f: any) => ({ ...f, originalInvoiceId: v })); clearError('originalInvoiceId'); }}
                                                icon={Receipt}
                                                placeholder={(form.customerId || form.supplierId) ? t('اختر الفاتورة...') : t('اختر العميل / المورد أولاً')}
                                    ...
                                    <div>
                                        <label style={{ ...LS, fontSize: '11px' }}>{t('المخزن (تسوية)')} <span style={{ color: C.danger }}>*</span></label>
                                        <div style={{ position: 'relative' }}>
                                            <CustomSelect
                                    ...
                                    <div>
                                        <label style={{ ...LS, fontSize: '11px' }}>{t('سبب المرتجع')}</label>
                                        <CustomSelect
                                            value={form.reason}
                        ...
                        {selectedInvoice && (
                            <div style={{ background: 'rgba(37, 106, 244,0.04)', border: `1px solid ${C.primary}30`, borderRadius: '12px', padding: '16px' }}>
                                <div style={{ fontSize: '13px', fontWeight: 600, color: '#256af4', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '8px', fontFamily: CAIRO }}>
                                    <Info size={16} /> {t('ملخص الفاتورة الأصلية')}
                                </div>
                                <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '12px' }}>
                                    {[
                                        ...
                                        { label: t('المحصل'), value: `${selectedInvoice.paidAmount.toLocaleString()} ${cSymbol}`, color: '#10b981' },
                            ...
                            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
                                <div style={{ padding: '12px 20px', borderBottom: `1px solid ${C.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <div style={{ fontSize: '13px', fontWeight: 600, color: '#256af4', display: 'flex', alignItems: 'center', gap: '8px', fontFamily: CAIRO }}>
                                        <RotateCcw size={16} /> {isServices ? t('الخدمات المراد إلغاؤها') : t('الأصناف المرتجعة')}
                                    </div>
                                    <div style={{ fontSize: '10px', color: C.textSecondary }}>{lines.length} {t('بند متاح')}</div>
                                </div>
                                    ...
                                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '11px' }}>
                                        <thead>
                                            <tr style={{ background: C.subtle, borderBottom: `1px solid ${C.border}` }}>
                                                ...
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('اسم البند')}</th>
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('الوحدة')}</th>
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('الكمية الأصلية')}</th>
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('سابق الإرجاع')}</th>
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('كمية المرتجع')}</th>
                                                <th style={{ padding: '12px', textAlign: 'center', color: C.textMuted, fontSize: '12px', fontWeight: 700, fontFamily: CAIRO }}>{t('سعر البيع')}</th>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                                ...
                                <div style={{ borderTop: `1px dashed ${C.border}`, paddingTop: '14px', marginTop: '14px' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                                        <span style={{ fontSize: '13px', color: C.textSecondary }}>{t('إجمالي المرتجع')}</span>
