                ...
                <div style={TABLE_STYLE.container}>
                    {loading ? (
                        ...
                        <div style={{ padding: '70px' }}>
                            <RotateCcw size={36} style={{ color: C.textSecondary, opacity: 0.3, display: 'block', margin: '0 auto 10px' }} />
                                    ...
                                    {filtered.map((r, idx) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td style={{ ...TABLE_STYLE.td(false, false), fontWeight: 600, fontSize: '13px', color: C.textPrimary, fontFamily: CAIRO }}>{r.customer?.name || '—'}</td>
