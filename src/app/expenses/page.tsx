                ...
                <DataTable
                    columns={[
                            ...
                            return (
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: C.textPrimary, fontWeight: 700, fontSize: '13px' }}>
                                        ...
                                        {row.sourceName || creditLine?.account?.name || '—'}
                                    </div>
                        ...
                        { header: t('المبلغ'), type: 'number', cell: (row) => {
                            const debitLine = row.lines.find((l: any) => l.debit > 0);
                            return <span style={{ fontSize: '13px', fontWeight: 600, color: C.textPrimary, fontFamily: OUTFIT }}>{fMoneyJSX(debitLine?.debit || 0)}</span>;
                        }},
                    ]}
                    data={paginated}
