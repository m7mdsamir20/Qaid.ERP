...
import {
    ...
    PAGE_BASE, BTN_PRIMARY, SEARCH_STYLE, KPI_STYLE, KPI_ICON
                            ...
                            <div key={i} style={KPI_STYLE(card.color)}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: '18px', fontWeight: 800, color: card.color, margin: 0, fontFamily: OUTFIT }}>
                                        {card.value}
                                        {card.suffix && <span style={{ fontSize: '11px', marginRight: '4px', fontFamily: CAIRO, opacity: 0.8 }}>{card.suffix}</span>}
                                    </p>
                                </div>
                            </div>
                        ))}
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                    ...
                                    <span style={{
                                        ...
                                        color: rep.isActive ? C.success : C.danger, fontFamily: CAIRO
                                    }}>
                                ...
                                {/* Name */}
                                <div>
                                    <p style={{ margin: '0 0 4px', fontWeight: 700, fontSize: '15px', color: C.textPrimary, fontFamily: CAIRO }}>{rep.name}</p>
                                    {rep.phone && (
                                        <p style={{ margin: '0 0 2px', fontSize: '12px', color: C.textSecondary, display: 'flex', alignItems: 'center', gap: '6px', fontFamily: CAIRO }}>
                                ...
                                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                    <span style={{
                                        ...
                                        background: `${C.teal}15`, color: C.teal, fontFamily: OUTFIT
                                    }}>
                                        عمولة {rep.commissionRate ?? 0}%
                                    </span>
                                    <span style={{
                                        padding: '4px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 600,
                                        background: 'rgba(255,255,255,0.05)', color: C.textSecondary, fontFamily: CAIRO
                                    }}>
                                ...
                                <div style={{ display: 'flex', gap: '16px' }}>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: C.textPrimary, fontFamily: OUTFIT }}>{rep._count?.customers ?? 0}</p>
                                        <p style={{ margin: 0, fontSize: '10px', color: C.textSecondary, fontFamily: CAIRO }}>عميل</p>
                                    </div>
                                    <div style={{ textAlign: 'center' }}>
                                        <p style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: C.textPrimary, fontFamily: OUTFIT }}>{rep._count?.invoices ?? 0}</p>
                                ...
                                <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
                                    <button
                                        ...
                                        style={{
                                            ...
                                            color: C.primary, cursor: 'pointer', fontSize: '12px',
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
                            ...
                            <div>
                                ...
                                <input style={IS} value={formData.code} onChange={e => setFormData({ ...formData, code: e.target.value })} placeholder="REP001" onFocus={focusIn} onBlur={focusOut} />
                            </div>
                        </div>
