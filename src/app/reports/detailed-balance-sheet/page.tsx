                            ...
                            <tbody>
                                {data.assets.map((a) => (
                                    <tr key={a.code} style={{ borderBottom: `1px solid ${C.border}`, transition: 'background 0.2s' }}>
                                        ...
                                        <td style={{ padding: '12px 16px',  fontWeight: 600, color: C.textPrimary, fontSize: '14px', fontFamily: INTER }}><Currency amount={a.balance} /></td>
                                    </tr>
                                ))}
                                <tr style={{ background: 'rgba(16, 185, 129, 0.08)', borderTop: `2px solid #10b98133` }}>
                                    ...
                                    <td style={{ padding: '16px 24px',  fontWeight: 950, color: '#10b981', fontSize: '14px', fontFamily: INTER }}><Currency amount={data.totalAssets} /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                                ...
                                <tbody>
                                    {data.liabilities.map((l) => (
                                        <tr key={l.code} style={{ borderBottom: `1px solid ${C.border}` }}>
                                            ...
                                            <td style={{ padding: '10px 16px',  fontWeight: 600, color: C.textPrimary, fontSize: '14px', fontFamily: INTER }}><Currency amount={l.balance} /></td>
                                        </tr>
                                    ))}
                                    ...
                                    <tr style={{ background: 'rgba(251, 113, 133, 0.05)', borderTop: `1px solid #fb718533` }}>
                                        ...
                                        <td style={{ padding: '12px 20px',  fontWeight: 900, color: '#fb7185', fontSize: '14px', fontFamily: INTER }}><Currency amount={data.totalLiabilities} /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    {data.equities.map((e) => (
                                        <tr key={e.code} style={{ borderBottom: `1px solid ${C.border}` }}>
                                            ...
                                            <td style={{ padding: '10px 16px',  fontWeight: 600, color: C.textPrimary, fontSize: '14px', fontFamily: INTER }}><Currency amount={e.balance} /></td>
                                        </tr>
                                    ))}
                                    <tr style={{ borderBottom: `1px solid ${C.border}`, background: 'rgba(59, 130, 246, 0.02)' }}>
                                        ...
                                        <td style={{ padding: '10px 16px',  fontWeight: 900, color: data.netIncome >= 0 ? '#10b981' : '#fb7185', fontSize: '14px', fontFamily: INTER }}><Currency amount={data.netIncome} /></td>
                                    </tr>
                                    <tr style={{ background: 'rgba(59, 130, 246, 0.08)', borderTop: `1px solid #3b82f633` }}>
                                        ...
                                        <td style={{ padding: '12px 20px',  fontWeight: 950, color: '#3b82f6', fontSize: '14px', fontFamily: INTER }}><Currency amount={data.totalEquities} /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div style={{
                            ...
                            alignItems: 'center'
                             ...
                             <span style={{ fontSize: '18px', fontWeight: 950, color: C.textPrimary, fontFamily: INTER }}><Currency amount={data.totalLiabilitiesAndEquities} /></span>
                        </div>
                    </div>
                </div>
