                            ...
                            <tbody>
                                {data.assets.map((a) => (
                                    <tr key={a.code} style={{ borderBottom: `1px solid ${C.border}`, transition: 'background 0.2s' }}>
                                        ...
                                        <td style={{ padding: '12px 16px', textAlign: 'start', fontWeight: 800, color: C.textPrimary, fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(a.balance)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                    </tr>
                                ))}
                                <tr style={{ background: 'rgba(16, 185, 129, 0.08)', borderTop: `2px solid #10b98133` }}>
                                    ...
                                    <td style={{ padding: '16px 24px', textAlign: 'start', fontWeight: 950, color: '#10b981', fontSize: '14px', fontFamily: INTER }}><span dir="ltr">{fmt(data.totalAssets)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                ...
                                <tbody>
                                    {data.liabilities.map((l) => (
                                        <tr key={l.code} style={{ borderBottom: `1px solid ${C.border}` }}>
                                            ...
                                            <td style={{ padding: '10px 16px', textAlign: 'start', fontWeight: 800, color: C.textPrimary, fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(l.balance)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                        </tr>
                                    ))}
                                    ...
                                    <tr style={{ background: 'rgba(251, 113, 133, 0.05)', borderTop: `1px solid #fb718533` }}>
                                        ...
                                        <td style={{ padding: '12px 20px', textAlign: 'start', fontWeight: 900, color: '#fb7185', fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(data.totalLiabilities)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    {data.equities.map((e) => (
                                        <tr key={e.code} style={{ borderBottom: `1px solid ${C.border}` }}>
                                            ...
                                            <td style={{ padding: '10px 16px', textAlign: 'start', fontWeight: 800, color: C.textPrimary, fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(e.balance)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                        </tr>
                                    ))}
                                    <tr style={{ borderBottom: `1px solid ${C.border}`, background: 'rgba(59, 130, 246, 0.02)' }}>
                                        ...
                                        <td style={{ padding: '10px 16px', textAlign: 'start', fontWeight: 900, color: data.netIncome >= 0 ? '#10b981' : '#fb7185', fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(data.netIncome)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                    </tr>
                                    <tr style={{ background: 'rgba(59, 130, 246, 0.08)', borderTop: `1px solid #3b82f633` }}>
                                        ...
                                        <td style={{ padding: '12px 20px', textAlign: 'start', fontWeight: 950, color: '#3b82f6', fontSize: '13px', fontFamily: INTER }}><span dir="ltr">{fmt(data.totalEquities)} <span style={{ fontFamily: "'Cairo', sans-serif", fontSize: '10px' }}>{sym}</span></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
