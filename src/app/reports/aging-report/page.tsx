                ...
                <div className="print-only">
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px', paddingBottom: '12px', borderBottom: '2px solid #000' }}>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <h3 style={{ margin: '0 0 6px', fontSize: '14px', fontWeight: 900, color: '#000', fontFamily: CAIRO }}>تقرير أعمار الديون</h3>
                            <div style={{ fontSize: '11px', color: '#000', fontWeight: 700, fontFamily: CAIRO }}>تاريخ التقرير: {new Date().toLocaleDateString('ar-EG')}</div>
                        </div>
                        ...
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <div style={{ textAlign: 'right' }}>
                                    ...
                                    <div style={{ fontSize: '9px', fontWeight: 800, color: s.color, fontFamily: CAIRO, marginTop: '2px' }}>{s.count} فاتورة | {s.sign}</div>
                                </div>
