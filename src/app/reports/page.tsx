...
function ReportsHubPageInner() {
    ...
    const REPORTS_DATA: Record<string, ReportLink[]> = {
        ...
        'partners': [
            { 
                title: hasCustomers && hasSuppliers 
                    ...
                    : hasCustomers 
                        ? t('أرصدة العملاء') 
                        : t('أرصدة الموردين'), 
                description: hasCustomers && hasSuppliers 
                    ? t('تقرير إجمالي لجميع العملاء والموردين يعرض من عليه أموال ومن له مستحقات') 
                    : hasCustomers 
                        ? t('تقرير إجمالي لجميع العملاء يعرض المبالغ المستحقة عليهم') 
                        : t('تقرير إجمالي لجميع الموردين يعرض المبالغ المستحقة لهم'), 
                href: '/reports/clients-suppliers-balances', 
                icon: Users, 
                color: '#256af4', 
                status: 'ready', 
                requiredPages: ['/customers', '/suppliers'] 
            },
            ...
            { 
                ...
                description: t('تأخيرات السداد والمستحقات الزمنية'), 
    ...
    const TABS: ModuleTab[] = [
        ...
        { 
            ...
            icon: Users,
            requiredFeatures: ['partners', 'sales', 'purchases']
        },
        { 
            key: 'treasury-bank', 
