...
import { RotateCcw, Plus, Printer, Loader2, Search, ChevronDown, Package, CheckCircle2, Clock, AlertCircle, Trash2, Eye, FileDown } from 'lucide-react';
...
export default function PurchaseReturnsListPage() {
    ...
    const filtered = returns.filter(r => {
        ...
        const matchSearch = (r.supplier?.name || '').toLowerCase().includes(s) || String(r.invoiceNumber).includes(s);
