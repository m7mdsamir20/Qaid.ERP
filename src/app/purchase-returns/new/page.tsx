...
import {
    ...
    Building2, UserCheck, FileText, Receipt, Package, CheckCircle2, ShoppingCart
} from 'lucide-react';
...
export default function NewPurchaseReturnPage() {
    ...
    useEffect(() => {
        ...
        const inv = purchaseInvoices.find(i => i.id === form.originalInvoiceId);
        if (!inv) return;
    ...
    }, [form.originalInvoiceId, purchaseInvoices]);
                                    ...
                                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', fontSize: '11px' }}>
                                        <thead>
                                            <tr style={{ background: 'rgba(0,0,0,0.1)', borderBottom: `1px solid ${C.border}` }}>
                                                ...
                                                <th style={{ padding: '10px', textAlign: 'right', color: C.textMuted, fontSize: '10px' }}>اسم الصنف</th>
