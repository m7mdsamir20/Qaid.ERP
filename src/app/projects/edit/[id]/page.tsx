                    ...
                    <form onSubmit={handleSubmit} className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr minmax(280px, 320px)', gap: '16px', alignItems: 'start' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            <div style={SC}>
                                ...
                                <textarea rows={3} placeholder={t('أي ملاحظات أو بنود خاصة...')} value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })} style={{ ...IS, height: 'auto', padding: '10px 14px', resize: 'none' }} onFocus={focusIn} onBlur={focusOut} />
                            </div>
                        </div>
                        ...
                        <div style={{ position: 'sticky', top: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            {/* Card 4: ملخص الربحية ونسبة الإنجاز */}
                            <div style={SC}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                    ...
                                    <div style={{ marginTop: '10px', paddingTop: '10px', borderTop: `1px dashed ${C.border}` }}>
                                        <label style={{ ...LS, fontSize: '11px' }}>{t('نسبة الإنجاز الكلية %')}</label>
                            ...
                            <div style={SC}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    <div>
                                        <label style={{ ...LS, fontSize: '11px' }}>{t('تاريخ الانتهاء الفعلي')}</label>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '4px' }}>
                                <button disabled={submitting} type="submit" style={BTN_PRIMARY(false, submitting)}>
                                    {submitting ? <Loader2 size={20} style={{ animation: 'spin 1s linear infinite' }} /> : <><Save size={18} /> {t('حفظ التعديلات')}</>}
                                </button>
