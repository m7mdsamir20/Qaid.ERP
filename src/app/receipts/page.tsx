...
import { Plus, Search, Loader2, Building2, Banknote, Printer, Receipt, Trash2, TrendingUp, Eye, FileDown } from 'lucide-react';
            ...
            <div dir={isRtl ? 'rtl' : 'ltr'} style={{ paddingBottom: '30px', background: C.bg, minHeight: '100%', fontFamily: CAIRO }}>
                ...
                <DataTable
                    columns={[
                        ...
                        { header: t('التاريخ'), type: 'date', cell: (row) => <span style={{ color: C.textSecondary, fontSize: '12px', fontFamily: OUTFIT }}>{new Date(row.date).toLocaleDateString('en-ZA')}</span> },
